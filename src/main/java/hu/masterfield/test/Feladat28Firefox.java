...
public class Feladat28Firefox {
    ...
    public void testFeladat28Firefox() throws InterruptedException {
        ...
        System.out.println(messageWebElement.getCssValue("background-color"));
        assertEquals("rgb(0, 0, 255)", messageWebElement.getCssValue("background-color"));
        ...
        Thread.sleep(2000);
        System.out.println(messageWebElement.getCssValue("background-color"));
        assertEquals("rgb(255, 255, 0)", messageWebElement.getCssValue("background-color"));
