...
public class Feladat30 {
    ...
    @Test
    public void testFeladat30() throws InterruptedException {
        driver.get(baseURL);
        Thread.sleep(3000);
        ...
        WebElement editMenuItemWebElement = driver.findElement(By.xpath("//span[span[text()='E'] and text()='dit']"));

        Actions builder = new Actions(driver);
        builder.contextClick(clickMeWebElement)
                .moveToElement(editMenuItemWebElement)
                .click()
                .build()
                .perform();
        Thread.sleep(3000);
        driver.switchTo().alert().accept(); // A megjelenő alert ablakon OK-ot nyomunk
        Thread.sleep(3000);
